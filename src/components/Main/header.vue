													...
													<div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
														...
														<div class="d-flex flex-column px-9">
															...
															<div class="text-center px-4">
																<img class="mw-100 mh-200px" alt="metronic" src="/media/illustrations/alert.png" />
															</div>
															<!--end::Illustration-->
														</div>
														<!--end::Wrapper-->
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
												...
												<div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start" data-kt-menu-flip="bottom, top">
													<a href="#" class="menu-link px-5">
														...
														<img class="w-15px h-15px rounded-1 ms-2" src="/media/flags/united-states.svg" alt="metronic" /></span></span>
													</a>
													<!--begin::Menu sub-->
													<div class="menu-sub menu-sub-dropdown w-175px py-4">
														<!--begin::Menu item-->
						...
						<div class="d-flex justify-content-end mb-10">
							...
							<div class="d-flex flex-column align-items-end">
								...
								<div class="d-flex align-items-center mb-2">
									...
									<!--begin::Avatar-->
									<div class="symbol symbol-35px symbol-circle">
										<img alt="Pic" src="/media/avatars/150-26.jpg" />
									</div>
									<!--end::Avatar-->
								</div>
								<!--end::User-->
								...
								<div class="row g-5">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative border border-4 border-success rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo1.png" alt="demo" class="w-100" />
											</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo2.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo3.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo4.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo5.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo6.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo7.png" alt="demo" class="w-100" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo8.png" alt="demo" class="w-100 opacity-75" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo9.png" alt="demo" class="w-100 opacity-75" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
												<div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
											</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo10.png" alt="demo" class="w-100 opacity-75" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
												<div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
											</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo11.png" alt="demo" class="w-100 opacity-75" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
												<div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
											</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo12.png" alt="demo" class="w-100 opacity-75" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
												<div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
											</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo13.png" alt="demo" class="w-100 opacity-75" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
												<div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
											</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo14.png" alt="demo" class="w-100 opacity-75" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
												<div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
											</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo15.png" alt="demo" class="w-100 opacity-75" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
												<div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
											</div>
									...
									<div class="col-6">
										...
										<div class="overlay overflow-hidden position-relative rounded">
											<div class="overlay-wrapper">
												<img src="/media/demos/demo16.png" alt="demo" class="w-100 opacity-75" />
											</div>
											<div class="overlay-layer bg-dark bg-opacity-10">
												<div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
											</div>
